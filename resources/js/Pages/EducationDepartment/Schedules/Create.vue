      ...
      <div class="d-flex align-center mb-6">
        ...
        <div>
          <h1 class="text-h4 font-weight-bold mb-2">
            {{ translations.education_department?.create_schedule || 'Создать расписание' }}
          </h1>
          <p class="text-body-1 text-medium-emphasis">
            {{ translations.education_department?.schedules_subtitle || 'Добавление нового расписания' }}
          </p>
        </div>
      </div>
